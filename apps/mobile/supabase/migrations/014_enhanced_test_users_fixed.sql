-- Migration: Enhanced Test User System (Fixed)
...
-- Recreate the can_user_access_coach function with consistent parameter names
...
-- Add RLS policies for test user metadata (drop existing first to avoid conflicts)
...
DROP VIEW IF EXISTS test_user_analytics;
